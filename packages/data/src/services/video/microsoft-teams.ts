...
export const MicrosoftTeams = defineService({
  id: 'microsoft-teams',
  ...
  directives: {
    ...
    'frame-src': ["https://teams.microsoft.com","https://*.teams.microsoft.com","https://*.teams.microsoft.us","https://local.teams.office.com"],
    'frame-ancestors': ["https://*.cloud.microsoft","https://teams.microsoft.com","https://*.teams.microsoft.com","https://*.teams.microsoft.us","https://local.teams.office.com","https://*.office.com","https://*.officeapps.live.com","https://*.microsoft.com","https://onedrive.live.com","https://*.onedrive.live.com"],
