...
export const AdobeAnalytics = defineService({
  ...
  directives: {
    ...
    'connect-src': ["https://*.2o7.net","https://*.omtrdc.net","https://*.demdex.net","https://*.adobe.com","https://*.omniture.com","https://*.adobedc.net"],
    'img-src': ["https://*.2o7.net","https://*.omtrdc.net","https://*.demdex.net","https://*.adobe.com","https://*.omniture.com"]
  },
  requiresNonce: true,
